...
1) открыть файл с экстрагированными спектрами
2) клавиша m - отметить точку континуума.
3) клавиша d - удалить отметку.
4) клавиша f - фитировать полином с континуумом. порядок полинома указывается.
...
Label_1 = Label(root, width=9, justify='right', bg = "grey", text = "Poly. order:")
